                    ...
                    <div class="text-left flex-grow-1">
                        ...
                        <div class="dropdown dropdown-inline">
                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php echo e(Metronic::getSVG("media/svg/icons/Communication/Add-user.svg", "svg-icon-lg")); ?>
                            ...
                            <div class="d-flex flex-column mb-5 align-items-start">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-40 mr-3">
                                        <img alt="Pic" src="<?php echo e(asset('media/users/300_12.jpg')); ?>"/>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex flex-column mb-5 align-items-end">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-40 ml-3">
                                        <img alt="Pic" src="<?php echo e(asset('media/users/300_21.jpg')); ?>"/>
                                    </div>
                                </div>
...
<?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/layout/partials/extras/_chat.blade.php ENDPATH**/ ?>