                ...
                <tbody style="" class="datatable-body">
                    ...
                    <tr data-row="5" class="datatable-row datatable-row-even" style="left: 0px;">
                        ...
                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;"><?php echo e($option); ?></span></td>
                        ...
                        <td>
                            <div class="btn-group" style="position: relative; left:-60px;">
                                <a href="#"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#updateModal" data-id="<?php echo e($option); ?>">
                                ...
                                <form method="POST" action="#">
                                    ...
                                    <button class="btn  deleteOption" data-id="<?php echo e($option); ?>">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
...
<?php echo $__env->make('option.addOption', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('option.option', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/option/index.blade.php ENDPATH**/ ?>