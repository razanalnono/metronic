...
<script>
    ...
    $.ajax({
    url:"<?php echo e(route('add.value')); ?>",
    method:'post',
    data:formData,
    processData: false,
    contentType: false,
...
$(document).on('click','.deleteValue',function(e){
    ...
    $.ajax({
    url:"<?php echo e(route('delete.value')); ?>",
    method:'post',
    data:{
...
</script><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/attributeValues/value.blade.php ENDPATH**/ ?>