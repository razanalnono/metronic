                ...
                <div class="col-md-10">
                    <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                        ...
                        <div class="d-flex flex-column align-items-md-end px-0">
                            ...
                            <span class=" d-flex flex-column align-items-md-end opacity-70">
                                <span><?php echo e(config('app.name','Selsela Store')); ?></span>
                    ...
                    <div class="d-flex justify-content-between pt-6">
                        <div class="d-flex flex-column flex-root">
                            ...
                            <span class="opacity-70"><?php echo e($order->created_at->format('Y-m-d')); ?></span>
                        </div>
                        <div class="d-flex flex-column flex-root">
                            <span class="font-weight-bolder mb-2">ORDER NO.</span>
                            <span class="opacity-70"><?php echo e($order->id); ?></span>
                        </div>
                        <div class="d-flex flex-column flex-root">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="font-weight-bolder">
                                    <td><?php echo e($order->payment_type->name ?? "UNPAID"); ?></td>
                                    <td>Jan 07, 2020</td>
                                    <td>Jan 07, 2020</td>
                                    <td class="text-primary font-size-h3 font-weight-boldest text-right"><?php echo e($total ??"0"); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/orders/show.blade.php ENDPATH**/ ?>