...
$.ajax({
url:"<?php echo e(route('add.variation')); ?>",
method:'post',
data:formData,
processData: false,
contentType: false,
...
$.ajax({
url:"<?php echo e(route('update.variation')); ?>",
method:'post',
data: formData,
processData: false,
contentType: false,
...
$.ajax({
url:"<?php echo e(route('delete.variation')); ?>",
method:'post',
data:{
...
</script><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/variation/variation.blade.php ENDPATH**/ ?>