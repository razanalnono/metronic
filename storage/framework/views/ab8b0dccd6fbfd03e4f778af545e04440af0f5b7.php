...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Cases Table
            </h3>
        </div>
    ...
    left: 69pc;"><a href="#" class="btn btn-light-info font-weight-bolder btn-md addAttributeForm"
            data-bs-toggle="modal" data-bs-target="#addModal">New Case</a></div>
                ...
                <thead class="datatable-head">
                    <tr class="datatable-row" style="left: 0px;">
                        ...
                        <th data-field=" Car Make" class="datatable-cell datatable-cell-sort"><span
                                style="width: 126px;">Case Name</span></th>
                ...
                <tbody style="" class="datatable-body">
                    ...
                    <tr data-row="5" class="datatable-row datatable-row-even" style="left: 0px;">
                        ...
                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;"><?php echo e($case->name); ?></span></td>


                        <td>
                            <div class="btn-group" style="position: relative; left:-60px;">
                                <a href="#"
                                    class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 updateCaseForm"
                                    data-bs-toggle="modal" data-bs-target="#updateModal" data-id="<?php echo e($case->id); ?>"
                                    data-name="<?php echo e($case->name); ?>">
                                ...
                                <form method="POST" action="#">
                                    ...
                                    <button class="btn  deleteCase" data-id="<?php echo e($case->id); ?>">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
...
<?php echo $__env->make('cases.addCase', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('cases.case', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('cases.updateCase', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/cases/index.blade.php ENDPATH**/ ?>