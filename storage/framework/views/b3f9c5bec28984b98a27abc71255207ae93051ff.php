...
<script>
    ...
    e.preventDefault();
    let myForm = document.getElementById('addCaseForm');
    var formData = new FormData(myForm);

    $.ajax({
    url:"<?php echo e(route('add.case')); ?>",
    method:'post',
    data:formData,
    processData: false,
    contentType: false,
    ...
    $('.'+err+'_err').html(formErr[err][0]);
        ...
        $(document).on('click','.updateCaseForm',function(){
        let id=$(this).data('id');
...
$(document).on('click','.updateCase',function(e){
e.preventDefault();
var formData = new FormData($('#updateCaseForm')[0]);
$.ajax({
url:"<?php echo e(route('update.case')); ?>",
method:'post',
data: formData,
processData: false,
contentType: false,
...
</script><?php /**PATH D:\metronic_v7.2.8_2\metronic_v7.2.8\theme\html_laravel\demo1\skeleton\resources\views/cases/case.blade.php ENDPATH**/ ?>