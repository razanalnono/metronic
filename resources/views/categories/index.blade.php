                ...
                <tbody style="" class="datatable-body">
                    ...
                    <tr data-row="5" class="datatable-row datatable-row-even" style="left: 0px;">
                        ...
                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;">{{ $category->getTranslation('name','en') }}</span></td>
                        <td data-field="Order Date" aria-label="2016-07-23" class="datatable-cell"><span
                                style="width: 126px;">{{ $category->getTranslation('name','ar') }}</span></td>



                        <td data-field="Order ID" aria-label="54753-003" class="datatable-cell">
                            <span style="width: 126px; position: relative;
                             left: 0pc;">{{count($category->products)}}</span>
                        </td>

                        <td data-field="Order ID" aria-label="54753-003" class="datatable-cell">
                            <span style="width: 126px; position: relative;
                             left: -2pc;">{{$category->slug}}</span>
                        </td>

                        <td data-field="Order ID" aria-label="54753-003" class="datatable-cell">
                            <span style="width: 126px; position: relative;
                                                     left: -2pc;">{{$category->parent->name}}</span>
                        </td>
                        <td>
                            <div class="btn-group" style="position: relative; left:-60px;">
                                <a href="#"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#updateModal" data-id="{{ $category->id }}"
                                ...
                                <form method="POST" action="#">
                                    @csrf
                                    @method('delete')
                                    <button class="btn  deleteCategory" data-id="{{ $category->id }}">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
...
@include('categories.addCategory')
