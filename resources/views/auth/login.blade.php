                    ...
                    <div class="login-form login-signin">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="email" class="block mt-1 w-full form-control form-control-solid h-auto py-5 px-6" type="email" name="email"
                            ...
                            <div class="mt-4 form-group">
                                ...
                                <x-text-input id="password" class="block mt-1 w-full form-control form-control-solid h-auto py-5 px-6" type="password" name="password"
