                ...
                <div class="modal-body row">
                    ...
                    {{-- <div class="form-group col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select name="attributes[]" class="form-control" id="attribute_id">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="value[]" class="form-control" id="value_{{ $attribute->id }}"
                                    placeholder="Enter value for {{ $attribute->name }}" style="display:none">
                            </div>
                        </div>
                        @endforeach
                    </div>
