...
<td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span style="width: 126px;">{{
            $variation->product->name}}</span></td>
...
<td data-field="Order ID" aria-label="54753-003" class="datatable-cell">
                        ...
                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;">{{
                                $variation->price}}</span></td>

                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;">{{
                                $variation->quantity}}</span></td>
                        <td>
                            <div class="btn-group" style="position: relative; left:-60px;">
                                <a href="#"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#updateModal" data-id="{{ $variation->id }}">
                                ...
                                <form method="POST" action="#">
                                    @csrf
                                    @method('delete')
                                    <button class="btn  deleteVariation" data-id="{{ $variation->id }}">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
