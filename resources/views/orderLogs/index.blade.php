            ...
            <table class="datatable-bordered datatable-head-custom datatable-table" id="kt_datatable"
                ...
                <thead class="datatable-head">
                    <tr class="datatable-row" style="left: 0px;">
                        ...
                        <th data-field=" Car Make" class="datatable-cell datatable-cell-sort"><span
                                style="width: 126px;">Attribute Value</span>
                        </th>
                ...
                <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 updateLogForm" data-bs-toggle="modal"
                    data-bs-target="#updateModal" data-id="{{ $log->id }}">
                                ...
                                <form method="POST" action="#">
                                    @csrf
                                    @method('delete')
                                    <button class="btn  deleteLog" data-id="{{ $log->id }}">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
...
@include('orderLogs.addLog')
@include('orderLogs.log')
@include('orderLogs.updateLog')
