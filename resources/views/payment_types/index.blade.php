                ...
                <tbody style="" class="datatable-body">
                    ...
                    <tr data-row="5" class="datatable-row datatable-row-even" style="left: 0px;">
                        ...
                        <td data-field="Deposit Paid" aria-label="$39286.74" class="datatable-cell"><span
                                style="width: 126px;">{{ $type->name }}</span></td>
                        ...
                        <td>
                            <div class="btn-group" style="position: relative; left:-60px;">
                                <a href="#"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#updateModal" data-id="{{ $type->id }}"
                                    data-name="{{ $type->name}}">
                                ...
                                <form method="POST" action="#">
                                    @csrf
                                    @method('delete')
                                    <button class="btn  deleteType" data-id="{{ $type->id }}">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
...
@include('payment_types.addType')
@include('payment_types.paymentType')
{{-- @include('payment_types.updateType') --}}
